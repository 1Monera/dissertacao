...
optimizer.max
'''
{'target': -0.291511648968508,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -3.3010299956639813,
  'paciencia': 10.0,
  'regpar_eff': -5.005399708582871,
  'regpar_latP': -7.0,
  'regpar_latU': -6.282360664111005,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-5.005399708582871),regpar_latU=10**(-6.282360664111005),regpar_latP=10**(-7),

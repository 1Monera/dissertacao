###############################################################################
# ADINs - base original com covariáveis [D] - dim 1
...
optimizer.max
'''
{'target': -0.4346736572996166,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 8.460818216353482,
  'learning_rate': -1.3010299956639813,
  'paciencia': 8.723362216320595,
  'regpar_eff': -3.0,
  'regpar_latP': -5.66967504332177,
  'regpar_latU': -3.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-3),regpar_latU=10**(-3),regpar_latP=10**(-5.66967504332177),

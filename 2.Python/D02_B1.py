...
optimizer.max
'''
{'target': -0.4969814389402889,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 9.146271899302356,
  'learning_rate': -3.3010299956639813,
  'paciencia': 7.811864726537007,
  'regpar_eff': -3.823208678975344,
  'regpar_latP': -4.929557156401314,
  'regpar_latU': -6.113922662172914,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-3.823208678975344),regpar_latU=10**(-6.113922662172914),regpar_latP=10**(-4.929557156401314),
...
modelo = f_treina_modelo(
    ...
    paciencia=8,ini_epoch=0,add_epoch=100,validation_split=0.1,
    batch_size=2**9,verbose=True)

...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-3),regpar_latU=10**(-7),regpar_latP=10**(-3.641647659351325),
...
modelo = f_treina_modelo(
    ...
    paciencia=10,ini_epoch=0,add_epoch=100,validation_split=0.08210436991927056,

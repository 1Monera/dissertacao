###############################################################################
# ADINs - base original sem covariáveis [A] - dim 2
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-4.480840427874601),

###############################################################################
# ADINs - base original com covariáveis [D] - dim 2
...
optimizer.max
'''
{'target': -0.43322594527232805,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 7.552809105267705,
  'learning_rate': -3.3010299956639813,
  'paciencia': 7.9768253124677635,
  'regpar_eff': -3.0,
  'regpar_latP': -7.0,
  'regpar_latU': -3.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-3),regpar_latU=10**(-3),regpar_latP=10**(-7),

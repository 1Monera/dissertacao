###############################################################################
# sen90 - base sem votações x com covariáveis [D] - dim 0
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.590549194867493,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 5.0,
  'learning_rate': -3.3010299956639813,
  'paciencia': 5.702606914404248,
  'regpar_eff': -7.0,
  'regpar_latP': -3.0,
  'regpar_latU': -5.076660736333878,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-5.076660736333878),regpar_latP=10**(-3),

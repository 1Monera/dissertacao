###############################################################################
# sen90 - base original com covariáveis [B] - dim 2
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.4442007950887123,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 5.0,
  'learning_rate': -1.3010299956639813,
  'paciencia': 10.0,
  'regpar_eff': -4.594053242841858,
  'regpar_latP': -7.0,
  'regpar_latU': -5.8022494779392355,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-4.594053242841858),regpar_latU=10**(-5.8022494779392355),regpar_latP=10**(-7),
...
modelo = f_treina_modelo(
    ...
    paciencia=10,ini_epoch=0,add_epoch=100,validation_split=0.01,

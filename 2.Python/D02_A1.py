...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-3.682918426915384),
    variaveis=variaveis,learning_rate=10**(-2.9378433792930556))

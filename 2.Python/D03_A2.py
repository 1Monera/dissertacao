...
optimizer.max
'''
{'target': -0.27429119100422883,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -1.3010299956639813,
  'paciencia': 8.198576577693306,
  'regpar_eff': -4.978310699169477,
  'regpar_latP': -7.0,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-4.978310699169477),regpar_latU=10**(-7),regpar_latP=10**(-7),

###############################################################################
# sen90 - base original com covariáveis [B] - dim 1
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.4295768088606149,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 5.7312648770604815,
  'learning_rate': -3.3010299956639813,
  'paciencia': 8.14336278363169,
  'regpar_eff': -7.0,
  'regpar_latP': -5.337055453995004,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-5.337055453995004),

###############################################################################
# sen90 - base sem votações x sem covariáveis [C] - dim 0
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.6119069449040121,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 7.197568046861892,
  'learning_rate': -3.3010299956639813,
  'paciencia': 10.0,
  'regpar_eff': -7.0,
  'regpar_latP': -6.649721099443314,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-6.649721099443314),

...
optimizer.max
'''
{'target': -0.39354960253637417,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -1.3010299956639813,
  'paciencia': 4.849810279388154,
  'regpar_eff': -4.588581052445828,
  'regpar_latP': -7.0,
  'regpar_latU': -5.187949647943638,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-4.588581052445828),regpar_latU=10**(-5.187949647943638),regpar_latP=10**(-7),

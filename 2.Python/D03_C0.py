...
optimizer.max
'''
{'target': -0.6298680956588361,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -3.0704033885137347,
  'paciencia': 2.020563509957167,
  'regpar_eff': -7.0,
  'regpar_latP': -7.0,
  'regpar_latU': -3.365188988929251,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-3.365188988929251),regpar_latP=10**(-7),
    variaveis=variaveis,learning_rate=10**(-3.0704033885137347))

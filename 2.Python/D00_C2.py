###############################################################################
# sen90 - base sem votações x sem covariáveis [C] - dim 2
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.4786818048478264,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 5.9291155928167925,
  'learning_rate': -1.3010299956639813,
  'paciencia': 3.3546873111846542,
  'regpar_eff': -7.0,
  'regpar_latP': -7.0,
  'regpar_latU': -5.962613384450187,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-5.962613384450187),regpar_latP=10**(-7),
...
modelo = f_treina_modelo(
    ...
    paciencia=3,ini_epoch=0,add_epoch=100,validation_split=0.1,

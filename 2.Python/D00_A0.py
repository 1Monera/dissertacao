###############################################################################
# sen90 - base original sem covariáveis [A] - dim 0
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.5579688525537081,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 6.277809462547779,
  'learning_rate': -1.3010299956639813,
  'paciencia': 5.264343738987614,
  'regpar_eff': -7.0,
  'regpar_latP': -4.914633007221926,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-4.914633007221926),

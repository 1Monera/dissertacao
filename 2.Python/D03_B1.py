...
optimizer.max
'''
{'target': -0.36720752876728335,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -3.3010299956639813,
  'paciencia': 4.012389859887691,
  'regpar_eff': -4.49921284754154,
  'regpar_latP': -7.0,
  'regpar_latU': -5.9546918878130635,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-4.49921284754154),regpar_latU=10**(-5.9546918878130635),regpar_latP=10**(-7),
...
modelo = f_treina_modelo(
    ...
    paciencia=4,ini_epoch=0,add_epoch=100,validation_split=0.1,

...
optimizer.max
'''
{'target': -0.4961731143578552,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 8.878692877720642,
  'learning_rate': -1.3010299956639813,
  'paciencia': 6.618305285488708,
  'regpar_eff': -5.880793884855476,
  'regpar_latP': -5.627751991711486,
  'regpar_latU': -3.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-5.880793884855476),regpar_latU=10**(-3),regpar_latP=10**(-5.627751991711486),
...
modelo = f_treina_modelo(
    ...
    paciencia=7,ini_epoch=0,add_epoch=100,validation_split=0.1,

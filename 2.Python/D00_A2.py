###############################################################################
# sen90 - base original sem covariáveis [A] - dim 2
###############################################################################
import sys
import os
import pandas as pd
...
optimizer.max
'''
{'target': -0.45110760571316294,
 'params': {'dim_latente': 2.0,
  'exp_p': 1.0,
  'expoente_batch_size': 5.0,
  'learning_rate': -1.3010299956639813,
  'paciencia': 4.295815649834499,
  'regpar_eff': -7.0,
  'regpar_latP': -6.753793888371045,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-6.753793888371045),

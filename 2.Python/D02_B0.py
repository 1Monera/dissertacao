...
optimizer.max
'''
{'target': -0.49774571550129487,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 8.345118778207656,
  'learning_rate': -3.279187877522517,
  'paciencia': 9.817689672632962,
  'regpar_eff': -6.150258465413723,
  'regpar_latP': -3.1108797026673525,
  'regpar_latU': -5.784928916468607,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-6.150258465413723),regpar_latU=10**(-5.784928916468607),regpar_latP=10**(-3.1108797026673525),
    variaveis=variaveis,learning_rate=10**(-3.279187877522517))

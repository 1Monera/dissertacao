...
'''
{'target': -0.5274820831432354,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 5.716066852770274,
  'learning_rate': -2.3010299956639813,
  'paciencia': 13.652621594425682,
  'regpar_eff': -7.0,
  'regpar_latP': -5.0,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-7),regpar_latP=10**(-5),
...
modelo = f_treina_modelo(
    ...
    paciencia=14,ini_epoch=0,add_epoch=500,validation_split=0.15,

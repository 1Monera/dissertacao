...
optimizer.max
'''
{'target': -0.6092787765478425,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -3.0650405456812484,
  'paciencia': 2.0,
  'regpar_eff': -7.0,
  'regpar_latP': -7.0,
  'regpar_latU': -3.543042624400578,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-7),regpar_latU=10**(-3.543042624400578),regpar_latP=10**(-7),
    variaveis=variaveis,learning_rate=10**(-3.0650405456812484))

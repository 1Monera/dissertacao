...
optimizer.max
'''
{'target': -0.3741448164289335,
 'params': {'dim_latente': 1.0,
  'exp_p': 1.0,
  'expoente_batch_size': 10.0,
  'learning_rate': -3.3010299956639813,
  'paciencia': 5.492439423985567,
  'regpar_eff': -4.327222763343795,
  'regpar_latP': -7.0,
  'regpar_latU': -7.0,
...
modelo = f_constroi_arquitetura(
    ...
    regpar_eff=10**(-4.327222763343795),regpar_latU=10**(-7),regpar_latP=10**(-7),
